...
# Time: 16:56 <br>
# Desc: opencv几何形状提取
# link：https://blog.csdn.net/gxiaoyaya/article/details/91362998
####################################################
#   作者:zhigang,
####################################################
import cv2 as cv
...
class ShapeAnalysis:
    ...
    def analysis(self, frame):
        ...
        cv.imwrite("out/extract.tif", self.draw_text_info(result))
        return self.shapes
...
if __name__ == "__main__":
    src = cv.imread("test.tif", cv2.IMREAD_GRAYSCALE)
    ld = ShapeAnalysis()
    ld.analysis(src)
    cv.waitKey(0)
